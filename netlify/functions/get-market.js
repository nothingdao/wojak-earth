// netlify/functions/get-market.js - FIXED to match working version
  ...
  try {
    ...
    const transformedListings = allMarketListings
      ...
      .map(listing => ({
        ...
        item: {
          ...
          layer_type: listing.item.layer_type,
          energy_effect: listing.item.energy_effect,
          health_effect: listing.item.health_effect
        },
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        isChildLocation: !!location.parent_location_id,
