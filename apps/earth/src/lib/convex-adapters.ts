...
export function adaptLocation(l: any): Location {
  ...
  return {
    ...
    mapRegionId: l.mapRegionId ?? l.svgPathId ?? null,
    svgPathId: l.svgPathId ?? null,
    legacyId: l.legacyId ?? null,
    biome: l.biome ?? null,
    territory: l.territory ?? null,
    theme: l.theme ?? null,
    lore: l.lore ?? null,
    imageUrl: l.imageUrl ?? null,
    isExplored: l.isExplored ?? null,
    minLevel: l.minLevel ?? null,
    entryCost: l.entryCost ?? null,
    mapX: l.mapX ?? null,
    mapY: l.mapY ?? null,
