...
export function ErrorScreen({ error }: ErrorScreenProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-background border border-error/50 rounded-lg p-4 font-mono">
        {/* Terminal Header */}
        <div className="flex items-center justify-between mb-3 border-b border-error/30 pb-2">
          ...
          <div className="flex items-center gap-2">
            <Activity className="w-3 h-3 animate-pulse text-error" />
        ...
        <div className="bg-red-950/20 border border-error/30 rounded p-3 mb-3">
          <div className="text-center">
            ...
            <div className="text-error font-bold mb-1">SYSTEM_ERROR_DETECTED</div>
        ...
        <div className="bg-muted/20 border border-error/10 rounded p-2 mb-3">
          <div className="text-xs text-red-400 font-mono">
            <div className="text-error text-xs font-bold mb-1">[ERROR_LOG]</div>
            <div>MODULE: APPLICATION_CORE • STATUS: RECOVERY_AVAILABLE</div>
          </div>
        </div>

        {/* Footer */}
        <div className="text-xs text-red-400/60 font-mono text-center border-t border-error/20 pt-2">
