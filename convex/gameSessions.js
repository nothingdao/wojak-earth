...
export const update = mutation({
    args: {
        ...
        status: v.optional(v.union(v.literal("active"), v.literal("ending"), v.literal("ended"))),
    },
...
export const setAstrdsEarnedHttp = httpAction(async (ctx, request) => {
    ...
    const { sessionId, amount, amountRaw, allocated, burned, allocatedRaw, burnedRaw, settlementTxSignature } = body;
